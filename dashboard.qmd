...
```{r}
#| content: valuebox
#| title: "Avg. Inflight Service Rating"
#| icon: headset
#| color: primary
#| value_text: "**`r avg_service_rating`**"
#| value_text_size: "sm"
list(
...
ggplot(data_long, aes(x = Category, y = Rating)) +
  ...
  labs(x = "Inflight Service Category", y = "Rating (6 point likert scale") +
  theme_minimal()
